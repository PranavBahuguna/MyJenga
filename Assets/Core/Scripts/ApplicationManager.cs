...
namespace MyJenga.Core.Scripts
{
	...
	using TowerGrade = JengaTowerManager.TowerGrade;
	...
	public class ApplicationManager : MonoBehaviour
	{
		...
		private JengaTowerManager _towerManager;
		...
		private void ShowHelpUI(bool open)
		{
			...
			_uiOpen = open;
			_helpPanelUI.gameObject.SetActive(open);
		}
		...
		private void ShowQuitUI(bool open)
		{
			...
			_uiOpen = open;
			_quitPanelUI.gameObject.SetActive(open);
		}
